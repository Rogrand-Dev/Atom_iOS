...
class EmptyDataSetView: UIView {
    ...
    lazy var button: UIButton! = UIButton(type: .custom).then {
        ...
        $0.layer.borderColor = UIColor.init(red: 211/255, green: 211/255, blue: 211/255, alpha: 1.0).cgColor
    ...
    func setupConstraints() {
        ...
        if let _ = customView {
            ...
            addContentViewConstraint(stepImageView: {
                ...
                views["button"] = $0
                contentView.addConstraint(NSLayoutConstraint.init(item: button, attribute: NSLayoutAttribute.height, relatedBy: NSLayoutRelation.equal, toItem: nil, attribute: NSLayoutAttribute.notAnAttribute, multiplier: 1.0, constant: 32.0))
                contentView.addConstraint(NSLayoutConstraint.init(item: button, attribute: NSLayoutAttribute.width, relatedBy: NSLayoutRelation.equal, toItem: nil, attribute: NSLayoutAttribute.notAnAttribute, multiplier: 1.0, constant: 80.0))
                contentView.addConstraint(NSLayoutConstraint.init(item: button, attribute: NSLayoutAttribute.centerX, relatedBy: NSLayoutRelation.equal, toItem: contentView, attribute: NSLayoutAttribute.centerX, multiplier: 1.0, constant: 0.0))
...
extension UIView {
    ...
    fileprivate func equallyRelatedConstraintWithView(_ view: UIView, attribute: NSLayoutAttribute) -> NSLayoutConstraint {
